...
OBJECTS += controller/BMSController.o
OBJECTS += controller/ContactorController.o
OBJECTS += controller/InsulationMonitoringDevice.o
OBJECTS += controller/StackPlausibility.o
OBJECTS += controller/StateController.o
OBJECTS += dispatcher/ContactorInfoDispatcher.o
OBJECTS += dispatcher/HeartbeatDispatcher.o
OBJECTS += dispatcher/StatusDispatcher.o
OBJECTS += main.o
...
OBJECTS += net/CANTransceiver.o


INCLUDE_PATHS += -I../
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I../controller
INCLUDE_PATHS += -I../core
INCLUDE_PATHS += -I../dispatcher
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1505213212.17
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1505213212.17
